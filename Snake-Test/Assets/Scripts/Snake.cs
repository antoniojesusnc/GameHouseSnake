...
namespace GameHouse.Snake.GamePlay
{
    public class Snake : MonoBehaviour
    {
        ...
        private void HandleGridMovement()
        {
            ...
            if (gridMoveTimer >= gridMoveTimerMax)
            {
                ...
                SnakeMovePosition snakeMovePosition =
                    new SnakeMovePosition(previousSnakeMovePosition, gridPosition, gridMoveDirection);
        ...
        private class SnakeMovePosition
        {
            ...
            public SnakeMovePosition(SnakeMovePosition previousSnakeMovePosition, Vector2Int gridPosition,
                Direction direction)
            {
